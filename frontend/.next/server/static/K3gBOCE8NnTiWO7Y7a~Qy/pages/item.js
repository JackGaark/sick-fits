  ...
  _createClass(SingleItem, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_apollo_["Query"], {
        ...
        var item = data.item;
        return external_react_default.a.createElement(SingleItemStyles, null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", null, " Sick Fits | ", item.title, " ")), external_react_default.a.createElement("img", {
          src: item.largeImage,
          alt: item.title
